    ...
    // colortex1: RGBA32UI
    void unpack_colortex1_read(uvec4 colortex_read, out vec4 normal_map_read, out vec4 specular_map_read, out vec2 lightmap_uv, out float material_id) {
        ...
        material_id = uintBitsToFloat(colortex_read.a);
    }
#endif
